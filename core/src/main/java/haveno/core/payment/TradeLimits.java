...
public class TradeLimits {
    private static final BigInteger MAX_TRADE_LIMIT = HavenoUtils.xmrToAtomicUnits(500.0); // max trade limit for lowest risk payment method. Others will get derived from that.
    @Nullable
    @Getter
